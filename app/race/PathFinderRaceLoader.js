...
angular.module('d20-pathfinder' ).run( function( RaceLoader, RaceLib, RaceDwarf, RaceElf, RaceGnome, RaceHalfElf, RaceHalfOrc, RaceHalfling, RaceHuman ) {
  var ID = 'pathfinder';
  ...
  PathFinderRaceLoader.prototype.load = function() {
    ...
    _.forEach([RaceDwarf, RaceElf, RaceGnome, RaceHalfElf, RaceHalfOrc, RaceHalfling, RaceHuman], function(race) {
